...
# TODO IMPLEMENT DICTIONARY SAVING/PASSING ON CITY AND COUNTY pages
# TODO ONCE ALL 3 LEVELS CREATE SAVED DICTIONARIES, IMPLEMENT PROVINCE PERSONpAGE CODE FOR CITY/COUNTY OFFICIALS, HAVING THEM WRITE TO THE SAME CSV AS THE PROVINCE ONE
# TODO - may need to work on not overwriting csv once city/county pages are added in
# TODO what about error handling when a page is missing?
# TODO TRACEBACK ERROR HANDLING?
    ...
    if province_counter < 3 :
        ...
        for province_official_name, holder_dict in province_officials_dict.items() :
            ...
            if provperson_counter < 5 :
                ...
                row_holder = [Prov, City, County, name, title_list[1], title_2, title_3, title_4, gender, ethnicity, dob_year, dob_month, birth_province, birth_place, education, date_archived, date_scraped, img_url, url_save_file_name, full_person_resume]
                ...
                prov_official_row = pd.DataFrame(prov_official_csv_holder, index=[PersonID], columns=['Province', 'City', 'County', 'Name','Title 1', 'Title 2', 'Title 3', 'Title 4', 'Gender', 'Ethnicity', 'Birth Year', 'Birth Month', "Birth Province", "Birth Place", "Education", "Archived", "Scraped", "Image URL", "Image Filename", "Resume"])
