...
# TODO see if the whole thing can write at once.  then go through and deal with common county-level errors, and the effed up pages
...
# TODO how to deal with "county person list generated WITH ERRORS?" -- go through when scraping full thing and manually do them?
        ...
        for citypage_nameonly_cleaned, city_holder_dict in citypage_officials_dict.items() :
            ...
            if cityperson_counter < 5 :
                ...
                # for everything that was archived
                    ...
                    PersonID = personID_function()
                    #personID_tester = [PersonID]
                    #print("personID = " + PersonID)
                    #print("personID_tester = " + str(personID_tester))
